...
echo \======================================================/
SET /P moddedFile=Please enter a name. (e.g. SMG - Cosmic Chaos.iso, SMG - Cosmic Chaos.wbfs): 
...
echo \==================================/
SET /P  newGameID=Please enter the new Game ID (e.g. SMGCC): 
...
echo \==============================/
SET /P  newTMD=Please enter the new TMD (e.g. SMGC): 
